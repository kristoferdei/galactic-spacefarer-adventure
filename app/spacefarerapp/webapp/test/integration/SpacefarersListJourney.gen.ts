...
function journey() {
    ...
    opaTest("Check filter bar", function (_Given: Given, _When: When, Then: Then) {
        ...
        Then.onTheSpacefarersListGenerated.onFilterBar().iCheckFilterField({ property: "wormholeSkill" });
    });
    ...
    opaTest("Check table columns and actions", function (_Given: Given, _When: When, Then: Then) {
        Then.onTheSpacefarersListGenerated.onTable(defaultTableId).iCheckColumns(undefined, {"name":{"header":"name"},"originPlanet":{"header":"Origin Planet"},"stardustCollection":{"header":"Stardust Collection"},"spacesuitColor":{"header":"Spacesuit Color"},"wormholeSkill":{"header":"Wormhole Navigation Skill"}});
    });
